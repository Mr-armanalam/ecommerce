...
const Nav = ({show, setshow}) => {
  ...
  const activeLink = inactiveLink + " bg-white text-blue-900 font-medium rounded-l-lg  ";
  ...
  return (
    <aside onClick={() => setshow(false)} 
    className={(show?'left-0':'-left-full') + " top-0 text-white p-4 pr-0 fixed w-full bg-blue-900 h-screen md:static md:w-auto transition-all "}
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <button onClick={() => lougout()} className={inactiveLink}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
